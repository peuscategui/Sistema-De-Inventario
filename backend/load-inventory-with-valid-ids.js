...
async function loadInventoryWithValidIds() {
  try {
      ...
      for (const line of lines) {
        if (line.trim()) {
          ...
          if (columns.length >= 26) {
            ...
            // Usar IDs válidos (1 para clasificación, 1 para empleado)
            const clasificacionIdNum = 1; // Primera clasificación
            const empleadoIdNum = 1; // Primer empleado
