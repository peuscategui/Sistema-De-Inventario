...
async function cargarInventoryCorrectoFinal() {
    ...
    try {
        ...
        // Leer el archivo limpio con precios corregidos
        console.log('📂 Cargando datos del archivo limpio...');
        const csvPath = path.join(__dirname, '05_inventory_limpio_precios.csv');
        ...
        for (let i = 1; i < lines.length; i++) {
            ...
            try {
                ...
                // Mapear las 27 columnas del CSV a las 28 columnas de la BD (excluyendo id)
                const insertQuery = `
