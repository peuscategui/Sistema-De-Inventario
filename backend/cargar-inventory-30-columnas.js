...
async function cargarInventory30Columnas() {
    ...
    try {
        ...
        // Parsear el CSV (ahora con 30 columnas)
        ...
        for (let i = 0; i < records.length; i++) {
            ...
            try {
                ...
                // Insertar registro (sin incluir la columna id del CSV)
                const insertQuery = `
