...
async function updateLT00265() {
  try {
    console.log('🔄 Conectando a la base de datos...');
    await client.connect();
    console.log('✅ Conexión exitosa\n');

    // Actualizar el registro LT-00265 con empleadoId 2
    ...
    if (rowCount > 0) {
      console.log('✅ LT-00265 actualizado con empleadoId: 2');
    } else {
      console.log('❌ No se encontró el registro LT-00265');
    }
