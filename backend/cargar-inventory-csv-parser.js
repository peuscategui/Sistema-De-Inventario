...
async function cargarInventoryCsvParser() {
    ...
    try {
        ...
        // Leer el archivo CSV con parser robusto
        console.log('📂 Leyendo archivo CSV con parser robusto...');
        ...
        for (let i = 0; i < records.length; i++) {
            ...
            // Manejar clasificacionId - CORREGIDO: está en la columna 26 (índice 25)
            ...
            // Manejar empleadoId - CORREGIDO: está en la columna 27 (índice 26)
            let empleadoId = null;
